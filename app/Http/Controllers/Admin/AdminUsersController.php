...
class AdminUsersController extends Controller
{
    ...
    public function user_course_allocation() {
        $packages = PackagingModel::with('course')
            ->select('course_id', 'level', 'semester')
            ->groupBy('course_id', 'level', 'semester')
            ->get();
        ...
        return view('admin_academics.users.user_course_allocation', compact('packages', 'students', 'lecturers'));
    }
