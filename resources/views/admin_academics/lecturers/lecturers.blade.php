            ...
            <div class="row justify-content-center">
                <div class="col-sm-12">
                    <div class="card user-profile-list">
                        <div class="card-body">
                            <b>Add New Lecturer</b>
                            <div class="form-container-row">
                                <input type="text" class="form-input" placeholder="Enter Lecturer ID/Index" />
                                
                                <input type="text" class="form-input" placeholder="Enter Name" />

                                <input type="text" class="form-input" placeholder="Enter Email" />

                                <input type="text" class="form-input" placeholder="Enter Phone" />

                                <input type="text" class="form-input" placeholder="Enter GPS" />
