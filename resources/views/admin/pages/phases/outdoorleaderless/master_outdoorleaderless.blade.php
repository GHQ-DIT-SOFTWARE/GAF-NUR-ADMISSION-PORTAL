            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">General Outdoorleaderless Reporting </h5>
                    </div>
                    <ul class="breadcrumb">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group form-focus">
                                        <select class="form-control select2" name="qualification">
                                            ...
                                            @foreach ($data->unique('outdoorleaderless_status') as $status)
                                                <option value="{{ $status->outdoorleaderless_status }}">
                                                    {{ $status->outdoorleaderless_status }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#main-vettings').DataTable({
                ...
                ajax: {
                    url: "{{ route('api-master-outdoorleaderless') }}",
                    type: 'POST',
                    headers: {
                ...
                columns: [{
                    ...
                    {
                        data: 'outdoorleaderless_status',
                        name: 'outdoorleaderless_status'
                    },
                    {
                        data: 'action',
                        name: 'action'
