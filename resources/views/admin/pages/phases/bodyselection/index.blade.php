        ...
        <div class="col-md-12 order-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('bodyselection.status-save-body-selection', $applied_applicant->uuid) }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <textarea class="form-control" name="result_verified_remarks"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
