...
@section('content')
                ...
                <div class="card-body">
                    <div class="row align-items-center m-l-0">
                        <div class="dt-responsive table-responsive">
                            <table id="main-baiscfitness" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>STATUS</th>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#main-baiscfitness').DataTable({
                ...
                ajax: {
                    url: "{{ route('api-applicant-basicfitness') }}",
                    type: 'POST',
                    headers: {
