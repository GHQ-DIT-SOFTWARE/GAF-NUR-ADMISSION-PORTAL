            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">General Basic Fitness Reporting </h5>
                    </div>
                    <ul class="breadcrumb">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group form-focus">
                                        <select class="form-control select2" name="qualification">
                                            ...
                                            @foreach ($data->unique('basic_fitness_status') as $status)
                                                <option value="{{ $status->basic_fitness_status }}">
                                                    {{ $status->basic_fitness_status }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#main-vettings').DataTable({
                ...
                ajax: {
                    url: "{{ route('api-master-basicfitness') }}",
                    type: 'POST',
                    headers: {
                ...
                columns: [{
                    ...
                    {
                        data: 'basic_fitness_status',
                        name: 'basic_fitness_status'
                    },
                    {
                        data: 'action',
                        name: 'action'
