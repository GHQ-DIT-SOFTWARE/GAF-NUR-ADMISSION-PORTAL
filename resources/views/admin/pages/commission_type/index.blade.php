            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Commission Type</h5>
                    </div>
                    <ul class="breadcrumb">
                ...
                <div class="card-body">
                    <div class="row align-items-center m-l-0">
                        <div class="col-sm-6 text-left"><br />
                            <p>Perform these Actions on Commission Type.</p>
                        </div>
                        <div class="col-sm-6 text-right"><br />
                            <div class="btn-group mb-2 mr-2" style="display: inline-block;">
                                <a href="{{ route('commissin.mech-commission-type') }}" class="btn  btn-primary "
                                    type="button" aria-haspopup="true" aria-expanded="false"><i
                                        class="feather icon-plus"></i>CommissionType</a>
                            </div>
                        </div>
                        <div class="dt-responsive table-responsive">
                            <div class="dt-responsive table-responsive">
                                <table id="example" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        @foreach ($commissions as $key => $record)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $record->commission_type }}</td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('commissin.edit-commission-type', $record->uuid) }}"><i
                                                            class="feather icon-edit"> </i></a>
                                                    <a class="btn btn-danger btn-sm"
                                                        href="{{ route('commissin.delete-commission-type', $record->uuid) }}"
